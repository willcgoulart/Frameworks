                ...
                <div class="col-lg-12">
                    <div class="m-5">
                        <div class="text-center">
                            <h1 class="mb-4">Cadastro Produto</h1>
                        </div> 
                        <form method="post" action="{{ route('form_cadastra_produto') }}">
                            @csrf        
                            <div class="form-label-group">
                                ...
                                id="desc_produto" name="desc_produto" value="{{ old('desc_produto' ?? '') }}">
                            ...
                            <div class="form-label-group">
                                ...
                                <select class="form-control {{ $errors->has("id_categoria") ? 'is-invalid' :'' }}" 
                                    ...
                                    @foreach ($categorias as $categoria)
                                        ...
                                        @if (old('id_categoria')==$categoria->id_categoria) 
                                            {{ 'selected' }} 
                                        @endif>
